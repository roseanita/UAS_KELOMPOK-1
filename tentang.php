						...
						<div class="row">
							<div class="col-12 col-md-6">
								...
								<aside class="d-flex justify-content-center items-center flex-column">
									<img src="assets/img/tentang/foto.png" alt="Tentang" style="width: 100%; border-radius:5px">
								</aside>
								<!-- End Aside -->
							</div>
							<div class="col-12 col-md-6">
								...
								<hr>
								<p class="mt-20 paragraf-deskripsi mb-20" style="text-align: justify; font-size: 20px;">
						...
						<div class="row partner-logos">
							<div class="col-md-3 col-6">
								<div class="partner-logo">
									<img class="img-fluid" src="assets/img/mitra/partner-1.png" alt="Mitra" srcset="assets/img/mitra/partner-1.png 1x, assets/img/mitra/partner-1@2x.png 2x">
								</div>
							</div>
							<div class="col-md-3 col-6">
								<div class="partner-logo">
									<img class="img-fluid" src="assets/img/mitra/partner-2.png" alt="Mitra" srcset="assets/img/mitra/partner-2.png 1x, assets/img/mitra/partner-2@2x.png 2x">
								</div>
							</div>
							<div class="col-md-3 col-6">
								<div class="partner-logo">
									<img class="img-fluid" src="assets/img/mitra/partner-3.png" alt="Mitra" srcset="assets/img/mitra/partner-3.png 1x, assets/img/mitra/partner-3@2x.png 2x">
								</div>
							</div>
							<div class="col-md-3 col-6">
								<div class="partner-logo">
									<img class="img-fluid" src="assets/img/mitra/partner-4.png" alt="Mitra" srcset="assets/img/mitra/partner-4.png 1x, assets/img/mitra/partner-4@2x.png 2x">
								</div>
							</div>
						</div>
					</div>
